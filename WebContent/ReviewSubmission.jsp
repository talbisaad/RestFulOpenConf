				...
				<tbody>
					<c:forEach begin="0" end="${lengh}" step="1" varStatus="loopCounter" items="${SubmissionList}" var="c">
						<tr>
							...
							<td><form action="SubmissionServlet?action=GetSubmissions" method="POST"><button style="border:0px solid black; background-color: transparent;" type="submit" name="Modifier"> <img alt="delete" class="deleteicone"
